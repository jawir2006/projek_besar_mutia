...
class Fungsi
{
    ...
    public static function app_nama()
    {
        try {
            ...
            // Periksa apakah settings tidak null dan memiliki properti app_nama
            if ($settings && isset($settings->app_nama)) {
                return $settings->app_nama;
            } else {
                // Jika tidak ada data settings atau properti app_nama kosong, kembalikan nilai default
                return "Penggajian Karyawan Guru Prestasi Prima";
            }
        } catch (\Exception $e) {
            // Tangani kesalahan jika terjadi
            \Log::error('Error retrieving app name: ' . $e->getMessage());
            return "Penggajian Karyawan Guru Prestasi Prima";
        }
    }
    ...
    public static function app_namapendek()
    {
        try {
            ...
            // Periksa apakah settings tidak null dan memiliki properti app_namapendek
            if ($settings && isset($settings->app_namapendek)) {
                return $settings->app_namapendek;
            } else {
                // Jika tidak ada data settings atau properti app_namapendek kosong, kembalikan nilai default
                return "Penggajian Karyawan Guru Prestasi Prima";
            }
        } catch (\Exception $e) {
            // Tangani kesalahan jika terjadi
            \Log::error('Error retrieving app short name: ' . $e->getMessage());
            return "Penggajian Karyawan Guru Prestasi Prima";
        }
    }
